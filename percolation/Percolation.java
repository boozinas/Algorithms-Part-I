...
public class Percolation {
    ...
    public void open(int row, int col) {
        ...
        int shiftRow = row - 1; // Para ajustar el valor ingresado al verdadero valor de la malla
        int shiftCol = col - 1;
    ...
    // Se alinea a un valor
    private int flattenGrid(int row, int col) {
        return gridSize * (row - 1) + col;
    }

    // Verifica si la fila y la columna ingresadas se encuentran en la malla
